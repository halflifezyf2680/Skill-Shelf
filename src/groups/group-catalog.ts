...
export const DEFAULT_MANAGED_GROUPS: ManagedGroupRecord[] = [
  seedGroup(
    ...
    ["software", "engineering", "backend", "frontend", "api", "database", "devops", "ai", "ml", "data", "code", "developer", "automation", "infra", "mobile"],
    ["software-engineering", "development", "tech"],
  ),
  seedGroup(
    "design",
    "UI/UX、品牌、视觉系统、设计语言、创意素材与体验表达。",
    ["design", "ui", "ux", "brand", "visual", "creative", "figma", "token", "identity", "banner", "icon", "styling"],
    ["visual-design", "ux-design"],
  ),
  seedGroup(
    "product",
    "产品规划、需求分析、用户反馈、优先级、路线图与产品研究。",
    ["product", "roadmap", "requirement", "feedback", "prioritization", "research", "insight", "discovery", "feature"],
    ["product-management"],
  ),
  seedGroup(
    "project-management",
    "项目推进、任务协调、里程碑、交付节奏与跨团队执行管理。",
    ["project", "program", "delivery", "milestone", "planning", "execution", "coordination", "timeline", "stakeholder"],
    ["pm", "program-management"],
  ),
  seedGroup(
    "marketing",
    "品牌营销、内容营销、市场传播、增长叙事与活动策略。",
    ["marketing", "brand", "content", "campaign", "growth", "messaging", "storytelling", "audience", "positioning"],
  ...
  seedGroup(
    ...
    ["sales", "lead", "pipeline", "prospect", "deal", "presales", "account", "crm", "closing"],
    ["business-development", "presales"],
  ),
  seedGroup(
    "finance",
    "财务、预算、核算、定价、经营分析与资金相关能力。",
    ["finance", "financial", "budget", "pricing", "accounting", "forecast", "cost", "revenue", "expense"],
    ["finops", "accounting"],
  ),
  seedGroup(
    "legal-compliance",
    "法务、合规、审计、政策、风险治理与监管要求处理。",
    ["legal", "compliance", "audit", "policy", "risk", "regulation", "governance", "contract", "privacy"],
    ["legal", "compliance", "risk"],
  ),
  seedGroup(
    "hr-talent",
    "招聘、人才、培训、组织发展与人事支持工作。",
    ["hr", "recruitment", "talent", "hiring", "people", "training", "onboarding", "candidate", "organization"],
    ["human-resources", "talent-acquisition"],
  ),
  seedGroup(
    "support-operations",
    "客服、运营支持、行政协助、汇总汇报与后台支持工作。",
    ["support", "operations", "assistant", "reporting", "responder", "summary", "maintainer", "tracker", "coordination"],
  ...
  seedGroup(
    ...
    ["academic", "research", "study", "historian", "anthropologist", "psychologist", "geographer", "scholar", "education"],
    ["research", "education"],
  ),
  seedGroup(
    "testing-qa",
    "测试、质量保障、评估、验证、审查与质量控制。",
    ["testing", "qa", "quality", "review", "audit", "validation", "verification", "benchmark", "eval"],
